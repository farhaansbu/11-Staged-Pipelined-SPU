...
#
#      xrun -f files.f -top tbench -access +rwc -input final-restore.tcl -input temp-restore.tcl
#
...
probe -create -database waves tbench.dut.hazard_detection.even_opcode tbench.dut.hazard_detection.even_instruction_type tbench.dut.hazard_detection.odd_instruction_type tbench.dut.hazard_detection.odd_opcode
probe -create -database waves tbench.dut.hazard_detection.id_rf_even_reg_write tbench.dut.hazard_detection.id_rf_even_rt_addr tbench.dut.hazard_detection.id_rf_odd_reg_write tbench.dut.hazard_detection.id_rf_odd_rt_addr tbench.dut.hazard_detection.rf_ex_even_reg_write tbench.dut.hazard_detection.rf_ex_even_rt_addr tbench.dut.hazard_detection.rf_ex_odd_reg_write tbench.dut.hazard_detection.rf_ex_odd_rt_addr tbench.dut.hazard_detection.even_stage_results tbench.dut.hazard_detection.odd_stage_results

simvision -input temp-restore.tcl.svcf
